                        ...
                        <div class="col-sm-6 border p-2">
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    ...
                                    <label for=""><?= label("doc_num_edit", $this); ?>&nbsp;&nbsp;<input disabled type="number" name="dc_data_edit" id="dc_data_edit" value="<?= $get_fulldatas->dc_data_edit; ?>" class="form-control"></label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    <label for=""><?= label("time_store", $this); ?>&nbsp;&nbsp;<input readonly type="number" name="dc_data_store" id="dc_data_store" value="<?= $get_fulldatas->dc_data_store; ?>" class="form-control">&nbsp;
                                        <!-- <select name="dc_data_store_type" id="dc_data_store_type" class="form-control" readonly>
