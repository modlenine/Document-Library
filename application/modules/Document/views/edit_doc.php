                        ...
                        <div class="col-sm-6 border p-2">
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    ...
                                    <select name="dc_data_dept" id="dc_data_dept" class="form-control" readonly>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label for=""><?= label("doc_name", $this); ?>&nbsp;&nbsp;<input type="text" name="dc_data_docname" id="dc_data_docname" value="<?= $get_fulldatas->dc_data_docname; ?>" class="form-control" readonly></label>
                                    <!-- Document name section -->
