...
<th style="text-align:right;">MO-F-001-04-02/05/61</th>
</tr>
</table><br>
...
$html .= '<input type="checkbox" name="dctype[]" value="'.$gettype['dc_type_code'].'" '.$checked.'>'.$gettype['dc_type_name'].'&nbsp;&nbsp;&nbsp;';
...
$html .='<input type="radio" name="dcsubtype" value="m" '.$m_check.' >&nbsp;Integration Manual (M)<br>
<input type="radio" name="dcsubtype" value="p" '.$p_check.' >&nbsp;Procedure (P)<br>
<input type="radio" name="dcsubtype" value="w" '.$w_check.' >&nbsp;Work Instruction (W)<br>
<input type="radio" name="dcsubtype" value="l" '.$l_check.' >&nbsp;Law (L)
</td>

<td style="border-right:1px solid #111111;font-size:16px;">
<input type="radio" name="dcsubtype" value="f" '.$f_check.' >&nbsp;Form (F)<br>
<input type="radio" name="dcsubtype" value="s" '.$s_check.' >&nbsp;Support Document (S)<br>
<input type="radio" name="dcsubtype" value="s" '.$x_check.' >&nbsp;External Document (X)<br>
<input type="radio" name="dcsubtype" value="sds" '.$sds_check.' >&nbsp;Safety Data Sheet (SDS)
</td>';
...
<tr>
<td style="font-size:16px;">
<input type="radio" name="reson_request" value="r-01" '.$r01.' >&nbsp;เอกสารใหม่ (New Release)<br>
<input type="radio" name="reson_request" value="r-02" '.$r02.' >&nbsp;เปลี่ยนแปลงเอกสาร (Change)

</td>
<td style="font-size:16px;">
<input type="radio" name="reson_request" value="r-03" '.$r03.' >&nbsp;ขอสำเนาเพิ่ม (Additional Copy)<br>
<input type="radio" name="reson_request" value="r-04" '.$r04.' >&nbsp;ขอแก้ไขเอกสาร (Revision)

</td>

<td style="font-size:16px;">
<input type="radio" name="reson_request" value="r-05" '.$r05.' >&nbsp;ขอยกเลิกเอกสาร (Obsolete)
</td>
...
<input type="checkbox" name="dept[]" value="'.$gd['related_code'].'" '.$deptchecked.' >&nbsp;'.$gd['related_dept_name'].'
...
<td style="font-size:16px;"><input type="radio" name="mgr_approve" value="1" '.$resonstatus1.'/>&nbsp;อนุมัติ</td>
<td style="font-size:16px;"><input type="radio" name="mgr_approve" value="0" '.$resonstatus0.'/>&nbsp;ไม่อนุมัติ</td>
</tr>
<tr>
...
<td style="font-size:16px;"><input type="radio" name="mgr_approve" value="1" '.$resonstatus21.'/>&nbsp;อนุมัติ</td>
<td style="font-size:16px;"><input type="radio" name="mgr_approve" value="0" '.$resonstatus20.'/>&nbsp;ไม่อนุมัติ</td>
</tr>
<tr>
